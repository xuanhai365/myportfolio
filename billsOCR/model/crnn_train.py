...
from EasyOCR.trainer.utils import CTCLabelConverter, AttnLabelConverter, Averager, AttrDict
...
from EasyOCR.trainer.train import count_parameters
from EasyOCR.trainer.mytest import validation
import argparse
import yaml
import os
import pandas as pd
...
def get_config(file_path):
    ...
    return opt
def train(args, show_number = 2, amp=False):
